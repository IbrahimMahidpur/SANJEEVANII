...
Loads documents from knowledge folder into ChromaDB
"""
...
def ingest_documents(
    ...
    """
    Ingest documents from folder into ChromaDB
    
    Args:
        folder_path: Path to knowledge folder (default: ./rag/knowledge)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Ingest CBT knowledge documents')
